...
import { getPrivacyScreenStyles } from '../styles/PrivacyScreenStyles';

const PrivacyScreen: React.FC = () => {
  const { t } = useTranslation();
  const { isDark } = useTheme();
  const styles = getPrivacyScreenStyles(isDark);
  ...
  return (
    <SafeAreaView className="flex-1" style={styles.screen}>
      ...
      <View className="flex-1 px-6 pt-10">
        ...
        {/* -------- ŞABLON DEMO: Gizlilik demo içeriği - Başlangıç - Yeni projede silinebilir -------- */}
        ...
        {/* -------- ŞABLON DEMO: Gizlilik demo içeriği - Bitiş -------- */}
